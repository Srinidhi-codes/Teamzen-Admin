                ...
                <div key={dept.id} className="group premium-card p-0 overflow-hidden hover:scale-102 flex flex-col border-border/50">
                    ...
                    <div className="h-28 bg-linear-to-br from-primary/20 via-primary/5 to-background relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-full opacity-10">
                            <Layers className="w-48 h-48 -rotate-12 translate-x-32 -translate-y-16 text-primary" />
                        </div>
                        <div className="absolute top-6 right-6">
                            <div className={`inline-flex items-center gap-2.5 px-4 py-2 rounded-2xl border backdrop-blur-xl shadow-lg ${dept.isActive
                                ? "bg-green-500/10 border-green-500/20 text-green-500 dark:text-green-500/50"
                                : "bg-destructive/10 border-destructive/20 text-destructive"
                                }`}>
                                <div className={`w-2 h-2 rounded-full ${dept.isActive ? "bg-green-500 shadow-green-500/50" : "bg-destructive shadow-destructive/50"} animate-pulse shadow-sm`} />
                    ...
                    <div className="px-8 pb-8 flex-1 flex flex-col">
                        ...
                        <div className="-mt-12 mb-8 flex items-end justify-between relative z-10">
                            <div className="flex items-end gap-4 px-1">
                                ...
                                <div className="mb-1">
                                    <h3 className="text-xl font-black text-foreground tracking-tight leading-none group-hover:text-primary transition-colors">{dept.name}</h3>
                        ...
                        <div className="mt-8 pt-8 border-t border-border/40">
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-black text-muted-foreground/60 uppercase tracking-[0.3em] italic">Dept ID: {dept.id.slice(0, 8)}</span>
                                </div>
