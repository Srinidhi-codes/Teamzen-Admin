'use client'
import { Users, UserCheck, Calendar, Clock, DollarSign, TrendingUp, Cake, Gift, PartyPopper, Star, Award, UserPlus, ArrowRight, UserPlus2, Banknote } from "lucide-react";
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-black text-foreground tracking-tight">Welcome back <span className="text-primary font-bold">{user?.firstName} {user?.lastName}!</span></h1>
                </div>
            ...
            {user?.role !== "manager" && <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-card rounded-3xl sm:rounded-4xl border border-border p-4 sm:p-8 shadow-xl shadow-primary/5 hover:shadow-primary/10 transition-shadow">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <AreaChart data={employeeGrowthData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                            <defs>
                            ...
                            <CartesianGrid vertical={false} stroke="var(--border)" strokeDasharray="5 5" opacity={0.5} />
                            <XAxis
                                dataKey="month"
                                axisLine={false}
                                tickLine={false}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div key={activity.id} className="flex items-start space-x-4 p-4 rounded-2xl hover:bg-muted/50 transition-colors group">
                                    ...
                                    <div className="flex w-full justify-between min-w-0">
                                        <p className="text-sm text-foreground">
                                            <span className="font-black text-primary">{activity.user}</span> <br /> <span className="text-muted-foreground font-medium capitalize">{activity.action}</span>
                                        </p>
                ...
                <div className="flex flex-col gap-5 h-full">
                    ...
                    <div className="w-full h-full bg-card rounded-3xl sm:rounded-4xl border border-border p-4 sm:p-8 shadow-xl shadow-primary/5 hover:shadow-primary/10">
