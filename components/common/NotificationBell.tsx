                        ...
                        notifications.map((notif: any) => (
                            ...
                            >
                                <div className="shrink-0 relative">
                                    <div className="w-10 h-10 rounded-xl bg-linear-to-br cursor-pointer from-primary/10 to-primary/5 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                        {getIcon(notif)}
                                    </div>
                                    {!notif.isRead && (
