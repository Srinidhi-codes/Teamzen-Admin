    ...
    <div className="min-h-screen flex items-center justify-center bg-background py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="animate-fade-in text-center">
          ...
          <h2 className="text-3xl font-extrabold text-foreground tracking-tight">Admin Portal</h2>
          <p className="mt-2 text-sm text-muted-foreground">Enter your credentials to manage payroll</p>
        </div>
        ...
        <div className="glass p-8 rounded-3xl animate-slide-up">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label htmlFor="email-address" className="text-sm font-medium text-foreground/80 ml-1">Email address</label>
          ...
          <div className="mt-8 pt-6 border-t border-border text-center">
            <p className="text-sm text-muted-foreground">
              Need access? <Link href="/register" className="font-semibold text-primary hover:opacity-80 transition-colors">Request an account</Link>
            </p>
          </div>
