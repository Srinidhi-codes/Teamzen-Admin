...
import { ArrowRight, Circle, Eye, EyeOff, LoaderCircle, Lock, Mail } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="animate-fade-in text-center">
          ...
          {/* </div> */}
          <h2 className="text-3xl font-extrabold text-foreground tracking-tight">Teamzen Admin Portal</h2>
              ...
              <div className="space-y-1.5">
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute inset-y-12 right-0 pr-3.5 flex items-center text-muted-foreground hover:text-primary transition-colors"
                  >
