...
function MapResizer({ employeeLat, employeeLng, officeLat, officeLng }: { employeeLat: number; employeeLng: number; officeLat: number; officeLng: number; }) {
    const map = useMap();
...
export default function AttendanceMap({
    ...
    const mapKey = useMemo(() => `${employeeLat}-${employeeLng}-${officeLat}-${officeLng}`, [employeeLat, employeeLng, officeLat, officeLng]);
