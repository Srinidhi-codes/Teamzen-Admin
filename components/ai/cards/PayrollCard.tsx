...
export const PayrollCard = ({
    ...
    return (
        <div className="relative overflow-hidden bg-card border border-border rounded-xl p-6 space-y-6 animate-in fade-in zoom-in-95 duration-700 w-full group/payroll">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs font-medium text-muted-foreground mb-0.5">Salary Insights</p>
                        <h4 className="text-sm font-semibold">{month} {year}</h4>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-xl bg-muted/30 border border-border relative overflow-hidden group/stat">
                    <div className="absolute top-0 right-0 p-2 opacity-10 group-hover/stat:scale-110 transition-transform">
                        <TrendingUp className="w-8 h-8" />
                    </div>
                    <p className="text-xs font-medium text-muted-foreground mb-1">Gross Earnings</p>
                    <p className="text-sm font-semibold">{gross}</p>
                </div>
                <div className="p-4 rounded-xl bg-primary text-primary-foreground relative overflow-hidden group/stat">
                    <p className="text-xs font-medium text-primary-foreground/70 mb-1">Net Payable</p>
                ...
                <div className="p-4 rounded-xl bg-muted/30 border border-border relative overflow-hidden group/stat">
                    ...
                    <p className="text-sm font-semibold text-rose-600 dark:text-rose-400">{deductions}</p>
                </div>
            </div>
            ...
            {(worked_days || lop) && (
                <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-muted/20 border border-border/30">
                        ...
                        <div>
                            <p className="text-xs font-medium text-muted-foreground leading-none mb-1">Worked Days</p>
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-muted/20 border border-border/30">
                        ...
                        <div>
                            <p className="text-xs font-medium text-muted-foreground leading-none mb-1">LOP Days</p>
            ...
            <div className="space-y-4 pt-2">
                ...
                {deductionsList.length > 0 && (
                    <div className="space-y-2">
                        <h5 className="text-xs font-medium text-rose-500/70 flex items-center gap-2">
