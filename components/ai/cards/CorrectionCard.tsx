    ...
    return (
        ...
        >
            ...
            <div className="flex items-start gap-3 mb-5">
                <div className="w-10 h-10 rounded-2xl flex items-center justify-center border bg-amber-500/10 border-amber-500/20 text-amber-600">
            ...
            {reason && !isConfirmed && (
                <div className="my-4 p-3 rounded-xl bg-muted/30 border border-border text-[11px] font-medium text-foreground/70 leading-relaxed line-clamp-3">
                    {reason}
                </div>
            )}
            ...
            {!isConfirmed ? (
                <button
                    ...
                    className="mt-5 w-full py-2.5 rounded-xl bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground text-xs font-medium transition-all duration-300 flex items-center justify-center gap-2 active:scale-95"
                >
                    <CheckCircle2 className="w-4 h-4" />
                    Confirm suggested logout
                </button>
            ) : (
                <div className="mt-5 w-full py-2.5 rounded-xl bg-muted/50 text-muted-foreground text-xs font-medium flex items-center justify-center gap-2 border border-border">
                    <CheckCircle2 className="w-4 h-4" />
                    Confirmed
                </div>
            )}
