...
export default function NotFound() {
  return (
    <div className="relative flex min-h-svh w-full items-center justify-center overflow-hidden">
      <Image
        src="/images/empty/empty-404.webp"
        alt=""
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-10 mx-auto w-full max-w-lg px-6 py-16 text-center">
        <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center overflow-hidden rounded-xl bg-card/90 ring-1 ring-border shadow-sm backdrop-blur-sm">
          <Image
