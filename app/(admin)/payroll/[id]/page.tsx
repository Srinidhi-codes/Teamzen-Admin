...
export default function PayrollRunDetailsPage({
  ...
  const [recalculatePayroll, { loading: recalculating }] =
    useMutation(INITIATE_PAYROLL_RUN);
    ...
    <div className="page-shell">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-3">
          ...
          <PageHeader
            ...
            description="Payslips, deductions, and payouts for this run."
          />
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        <Button
          ...
          disabled={publishing || run.status !== "completed"}
          variant="outline"
        >
        ...
        <Button
          ...
          disabled={paying || run.status !== "completed"}
        >
        ...
        <Button
          ...
          variant="outline"
        >
          <RefreshCcw className={cn("mr-2 h-4 w-4", recalculating && "animate-spin")} />
          Recalculate
        </Button>
      </div>
                ...
                <div className="flex gap-1">
                  <Button
                    ...
                    onClick={() => {
                      if (row.payslipPdf?.url) {
                        ...
                        toast.error("PDF not ready. Publish payslips first.");
                      }
                    }}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      else toast.error("User data missing for this payslip");
                    }}
