...
export const APPROVE_OR_REJECT_ATTENDANCE_CORRECTION = gql`
  mutation ApproveOrRejectAttendanceCorrection($input: ApproveAttendanceCorrectionInput!) {
    approveOrRejectAttendanceCorrection(input: $input)
  }
`;